...
-   When building in release, it takes 110-130ms to rasterize ~94 glyphs (standard latin characters and symbols found on a US keybaord) on a single thread on my Intel 185H CPU with Clang 18 & MSVC 19. This task is slow, so here are a few ideas to speed things up:
